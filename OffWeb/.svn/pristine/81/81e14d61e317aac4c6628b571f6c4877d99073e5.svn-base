...
function searchIndex(grade,name){
...
function _init_area(){  //初始化函数
	...
	if(document.getElementById("subarea").value!=""){
		var splitstr=$("#subarea").val().split('-');
		$("#s_province option[value='"+splitstr[0]+"']").attr("selected",true); 
		change(1);
		$("#s_city option[value='"+splitstr[1]+"']").attr("selected",true); 
		change(2);
		$("#s_county option[value='"+splitstr[2]+"']").attr("selected",true); 
	}
}
function showArea() {
	document.getElementById('subarea').value = document.getElementById('s_province').value 
